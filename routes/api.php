...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('user-show/{id}', [UserController::class, 'show'])->name('api.admin.user.show');
    ...
    Route::get('user-details-show/{id}', [UserDetailsController::class, 'show'])->name('api.admin.user_details.show');
    ...
    Route::get('role-show/{id}', [RoleController::class, 'show'])->name('api.admin.role.show');
    ...
    Route::get('access-right-show/{id}', [AccessRightsController::class, 'show'])->name('api.admin.access_right.show');
    ...
    Route::get('site-feature-show/{id}', [SiteFeatureController::class, 'show'])->name('api.admin.site_feature.show');
    ...
    Route::get('setting-show/{id}', [SettingController::class, 'show'])->name('api.admin.setting.show');
    ...
    Route::get('brand-show/{id}', [BrandController::class, 'show'])->name('api.admin.brand.show');
    ...
    Route::get('category-show/{id}', [CategoryController::class, 'show'])->name('api.admin.category.show');
    ...
    Route::get('product-show/{id}', [ProductController::class, 'show'])->name('api.admin.product.show');
    ...
    Route::get('product-image-show/{id}', [ProductImageController::class, 'show'])->name('api.admin.product_image.show');
    ...
    Route::get('product-stock-show/{id}', [ProductStockController::class, 'show'])->name('api.admin.product_stock.show');
    ...
    Route::get('project-show/{id}', [ProjectController::class, 'show'])->name('api.admin.project.show');
    ...
    Route::get('post-show/{id}', [PostController::class, 'show'])->name('api.admin.post.show');
    ...
    Route::get('comment-show/{id}', [CommentController::class, 'show'])->name('api.admin.comment.show');
    ...
    Route::get('review-show/{id}', [ReviewController::class, 'show'])->name('api.admin.review.show');
    ...
    Route::get('supplier-show/{id}', [SupplierController::class, 'show'])->name('api.admin.supplier.show');
    ...
    Route::get('coupon-show/{id}', [CouponController::class, 'show'])->name('api.admin.coupon.show');
    ...
    Route::get('payment-show/{id}', [PaymentController::class, 'show'])->name('api.admin.payment.show');
    ...
    Route::get('order-show/{id}', [OrderController::class, 'show'])->name('api.admin.order.show');
    ...
    Route::get('order-item-show/{id}', [OrderItemController::class, 'show'])->name('api.admin.order_item.show');
